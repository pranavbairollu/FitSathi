            ...
            FoodLogManager.getLastNDaysCalories(14, calorieHistory -> {
                ...
                if (Math.abs(dailyWeightChange) > 0.001) {
                    ...
                    if (daysToTarget > 0 && daysToTarget < 3650) { // Within 10 years
                        ...
                        reachTargetDate = "Target Reached!";
                    } else {
                        reachTargetDate = "Projected Trend Moving Away";
                    }
                } else {
                    reachTargetDate = "Stable Weight Trend";
                }

                callback.onProjectionCalculated(projection, dailyWeightChange, reachTargetDate);
            });
        });
    }
